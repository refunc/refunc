...
func (in *CommonTrigger) DeepCopyInto(out *CommonTrigger) {
	*out = *in
	if in.Args != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonTrigger.
func (in *CommonTrigger) DeepCopy() *CommonTrigger {
	if in == nil {
		return nil
	}
	out := new(CommonTrigger)
	in.DeepCopyInto(out)
	return out
}
...
func (in *XenvSpec) DeepCopyInto(out *XenvSpec) {
	*out = *in
	...
	if in.SideContainers != nil {
		in, out := &in.SideContainers, &out.SideContainers
